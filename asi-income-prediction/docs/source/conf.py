...
# asi_income_prediction documentation build
...
from asi_income_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "asi_income_prediction"
author = "Kedro"
...
htmlhelp_basename = "asi_income_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "asi_income_prediction.tex",
        "asi_income_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "asi_income_prediction",
        "Project asi_income_prediction codebase.",
        "Data-Science",
    )
]
